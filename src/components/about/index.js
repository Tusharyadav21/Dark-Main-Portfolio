...
import MarqueeText from "../motions/MarqueeText";
...
const About = () => {
	return (
		<div className={`${styles.container}`} id='about'>
			...
			<h5 className="text-md font-extrabold">A Full Stack Developer with 👌🏼 Javascript skills.</h5>
			<div className={styles.about_container}>
				<div>
					<h5 className="extrabold">Foundation & Journey</h5>
					<p>
				...
				<div>
					<h5 className="extrabold">Crafting Innovative Web Solutions</h5>
					<p>
